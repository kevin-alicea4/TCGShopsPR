...
public class DbsTournament extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("Dbs Tournaments");

        mListView = (ListView) findViewById(R.id.listView);

        mDatabase = FirebaseDatabase.getInstance().getReference();

        final CustomListAdapter adapter = new CustomListAdapter(this, R.layout.dbs_tournament,list, R.id.DbscardTitle, R.id.DbscardBody);

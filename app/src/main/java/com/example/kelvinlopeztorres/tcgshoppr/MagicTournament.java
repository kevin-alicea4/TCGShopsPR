...
public class MagicTournament extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("Magic Tournaments");

        mListView = (ListView) findViewById(R.id.listView);

        mDatabase = FirebaseDatabase.getInstance().getReference();

        final CustomListAdapter adapter = new CustomListAdapter(this, R.layout.magic_tournament,list, R.id.MagiccardTitle, R.id.MagiccardBody);

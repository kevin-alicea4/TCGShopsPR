...
public class PokemonTournament extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("Pokemon Tournaments");

        mListView = (ListView) findViewById(R.id.listView);

        mDatabase = FirebaseDatabase.getInstance().getReference();

        final CustomListAdapter adapter = new CustomListAdapter(this, R.layout.pokemon_tournament,list, R.id.PokemoncardTitle, R.id.PokemoncardBody);
        ...
        mDatabase.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(@NonNull DataSnapshot dataSnapshot, @Nullable String s) {
                ...
                Log.d("Entro", si);
                if (si.equals("Tournament Pokemon")){

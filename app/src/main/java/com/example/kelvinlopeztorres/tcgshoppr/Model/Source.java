...
public class Source {
    ...
    public Source(String id, String name, String description, String url, String category, String language, String country, UrlsLogos urlsLogos, List<String> sortByAvailable) {
        this.id = id;
        this.name = name;
